...
public class splitKeyValue121 extends UDF
{
    ...
    public static void main(String args[])
    {
        ...
        System.out.println(t.evaluate(new Text("schtype#ks,sssss#asaas"), new Text(","), new Text("#"), new IntWritable(2),new Text("schtype")));
    }
}
