...
public class FuncGetRfxChannelDetail2 extends UDF {
	...
	String lowerParam1;
	 ...
	 //0312 alter xxl
	 //lowerParam1.indexOf("|affiliate|")>-1 || 
	 if(lowerParam1.startsWith("bm|aff|cj"))
		{ //bbs
			 return "CJ";
		}
	 
	 if(lowerParam1.startsWith("bm|aff|neverblue"))
		{ //bbs
			 return "Neverblue";
		}
	 //0312 add xxl
	 if(lowerParam1.startsWith("bm|aff|kwanko"))
		{ //bbs
			 return "Kwanko";
		}
	...
	public static void main(String args[]){
		FuncGetRfxChannelDetail2 test = new FuncGetRfxChannelDetail2();
